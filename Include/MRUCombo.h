...
#define CMRUComboBoxBase CXTPImgComboBox
#else
#define CMRUComboBoxBase CComboBox
#endif

class CMRUComboBox : public CMRUComboBoxBase
{
...
public:
	...
	void EmptyMRU();
	void RemoveMRU(const unsigned int& nIndex);
